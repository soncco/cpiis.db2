...
/**
 * GestorIOTupla: Se encarga de entrada y salida de una tupla para el trabajo con paginas
 */
public class GestorIOTupla {
    ...
    public Par<Tupla, Integer> leerTupla(byte[] bytes, int inicio) {
        ...
        int celda = 0;
        for (Iterator<Atributo> it = relacion.iterator(); it.hasNext(); celda++) {
    ...
    public static void main(String args[]) {
        try {
            ...
            System.out.println(attrs.get(0).getTipo().toString());
            ...
            Tupla t = new Tupla(new IdentificadorTupla("redes.txt", 0), v);
...
//leer n tuplas y luego listar las n tuplas leidas